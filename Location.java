 ...
 * Each Location has a name but a fun fact about the location is optional.
 * 
 * @author Udit Patel
 * @version 12/5/2018
 */
public class Location {
	 ...
	 * @param location description of Location of Movie; should not be null or an empty String
